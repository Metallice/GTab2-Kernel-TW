...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_NONDEMAND)
extern struct cpufreq_governor cpufreq_gov_nondemand;
#define CPUFREQ_DEFAULT_GOVERNOR (&cpufreq_gov_nondemand)
#endif
